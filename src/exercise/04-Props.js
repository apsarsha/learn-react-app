...
function CompanyProfile(props) {
     ...
     */
    const stockTicker = props.ticker; //✏️ Instead of empty string we want to get this value from props
    const companyProfileInfo = props.profileInfo ; //✏️ Instead of empty object we want to get this value from props
    return (
        <div>
...
function FBCompanyProfile() {
     ...
     * */
    return (
        <CompanyProfile  ticker = {stockTicker} profileInfo = {companyProfileInfo}/>
    )
}
